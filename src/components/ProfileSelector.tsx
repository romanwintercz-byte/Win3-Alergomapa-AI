  ...
  return (
    <div className="w-full bg-white rounded-3xl p-4 md:p-6 shadow-sm border border-slate-200/80 mb-6">
      ...
      <div className="relative -mx-4 px-4 md:mx-0 md:px-0">
        <div className="flex items-center gap-2.5 overflow-x-auto pb-4 pt-1 snap-x hide-scrollbar pr-12 md:pr-0">
          {/* Family Summary Option */}
          <button
            onClick={() => setActiveProfileId('all')}
            className={cn(
              "flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold transition-all shrink-0 border snap-start",
              activeProfileId === 'all'
            ...
            return (
              <div key={p.id} className="relative group shrink-0 snap-start">
                ...
                <button
                  ...
                  className="absolute -top-1 -right-1 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity bg-white text-slate-500 p-1 rounded-full border border-slate-200 shadow-sm hover:text-indigo-600 z-10"
                >
